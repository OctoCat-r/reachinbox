...
const UserDetails: React.FC<userProps> = ({ singleMail }) => {
    console.log(singleMail)
  return (
    <div className="w-full px-2 border border-l-gray-300 mr-2 dark:border-l-gray-700">
      <div
        className={`w-full h-8 my-5 border border-gray-300 dark:border-gray-700 rounded "
        }`}
      >
      ...
      <div className="flex flex-col gap-5">
        <div className="flex justify-between mx-3 text-[14px]">
          <p>name</p>
          <p>{singleMail && singleMail[0]?.fromName}</p>
        </div>
        <div className="flex justify-between mx-3 text-[14px]">
          <p>Contact No</p>
          <p>+53 4245252354</p>
        ...
        <div className="flex justify-between mx-3 text-[14px]">
          <p>Email ID</p>
          <p className="text-[12px]">{singleMail && singleMail[0]?.fromEmail}</p>
        </div>
        <div className="flex justify-between mx-3 text-[14px]">
          <p>Linkedin</p>
      ...
      <div
        className={`w-full h-8 my-5 border border-gray-700 rounded "
        }`}
      >
        ...
        <div className="p-2 sm:p-5 font-sans font-semibold space-y-5">
          ...
          <div className="w-full space-y-6 ">
            <div className="flex gap-4">
              <div
                className={`rounded-3xl h-8 w-8 flex justify-center items-center`}
              >
                <Mail className="w-4" />
              </div>
              <div>
            ...
            <div className="flex gap-4">
              <div
                className={` rounded-3xl md h-8 w-8 flex justify-center items-center`}
              >
                <Mail className="w-4" />
              </div>

              <div>
                <div className={` text-sm mb-1`}>Step 3: Email</div>
                <div className="flex items-center gap-2">
                  <Mail className="w-3" />
                  <div className={` font-inter font-normal text-xs`}>
                    Opened <span className="font-normal">1st, March</span>
